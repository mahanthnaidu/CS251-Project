    ...
    <section class="u-clearfix u-image u-section-1" id="sec-6e18" data-image-width="1920" data-image-height="1080">
      <div class="u-clearfix u-sheet u-sheet-1">
        ...
        <?php 
            ...
            ?>
        <p class="u-custom-font u-text u-text-1">SCORE:&nbsp;<br>0<br>HIGHSCORE:<br><?php echo $_SESSION['highscore']; ?> 
          <br>
        </p>
        <p class="u-custom-font u-text u-text-default u-text-palette-2-base u-text-2">USERNAME:&nbsp;<br>&nbsp; &nbsp; &nbsp;<?php echo $_SESSION['username']; ?>
        ...
        <a href="https://nicepage.com/c/slider-html-templates" class="u-border-2 u-border-palette-2-base u-btn u-btn-round u-button-style u-hover-palette-2-base u-none u-radius-6 u-text-body-color u-text-hover-white u-btn-6">CREATE PRIVATE GAME</a>
      </div>
    </section>
    <script>
